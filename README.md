# Задание
Консольное приложение, реализующее функционал формирования чека в магазине. В приложении обработаны исключительные ситуации, а также реализованы паттерны проектирования Builder (для Receipt) и Factory (для exceptions).
## Содержание 
